...
- *"A category with slower catalog turnover could move it."* — **Still stands, and the gate that had closed the test of it has been reopened.** The external contrast that would test it (T8-4, MovieLens-32M) was gated on T8-2 confirming the null and was formally skipped when T8-2 met the any-cell criterion (`EXPERIMENT_LOG.md`, 2026-08-18). The 2026-08-19 supersession downgraded that verdict — local regime-cell wins under uncorrected multiplicity; the global history-depth null is robust — and the owner reopened T8-4 as approved scope with a preregistered multiplicity policy (UPGRADE_PLAN §8c; `EXPERIMENT_LOG.md`, 2026-08-19). Until that contrast runs, "the crossover exists only when the catalog holds still" remains an untested framing, not a finding of this lab.
...
- **No external replication yet; the low-churn contrast is reopened but not run.** T8-4 (MovieLens-32M, a deliberately different catalog-churn regime) was gated on Phase 8 confirming the null and was skipped when T8-2 met the any-cell criterion. The 2026-08-19 supersession downgraded that verdict and the owner reopened T8-4 as approved scope, with a preregistered multiplicity policy (primary test on the history axis; regime cells secondary, Benjamini–Hochberg FDR 0.05 per arm — UPGRADE_PLAN §8c). Until that contrast runs, the attractive framing "the crossover exists only when the catalog holds still" is an untested hypothesis in this lab, not a result of it, and every Phase 8 number remains a single-dataset, single-cutoff measurement.
