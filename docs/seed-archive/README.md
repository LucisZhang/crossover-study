...
| File | Why it's here (docs/engineering-log/UPGRADE_PLAN.md §3.4) |
|---|---|
...
The course project was five-person team work; see docs/engineering-log/UPGRADE_PLAN.md §11 for the required
provenance language.
