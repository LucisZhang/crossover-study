...
- **Experiment log published, failures included.** `EXPERIMENT_LOG.md` carries dated hypothesis → result → verdict entries including the rejected kNN neighbor-list hypothesis, the ALS negative, the content-alone rejection, the collapsed router, and the sub-expectation ANN overlap. **[measured]**
